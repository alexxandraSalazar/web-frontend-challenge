...
const ChangeIconComponent = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
    <svg
        width={24}
        height={24}
        viewBox="0 0 24 24"
    ...
    >
        ...
        <defs>
            <clipPath id="clip0_2604_655">
                <rect width={24} height={24} fill="white" />
            </clipPath>
        </defs>
    </svg>
);
export default ChangeIconComponent;
