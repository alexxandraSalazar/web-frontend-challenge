    ...
    return (
        <main className="p-4 md:p-6 w-full mx-auto">
            ...
            <section className="mb-12">
                <h2 className="text-h1 mb-6 text-black font-bold">Cuentas</h2>
            ...
            <section className="w-full">
                ...
                <div className="flex items-center gap-2 mb-8 border-b border-transparent overflow-x-auto">
                    {TABS.map((tab) => (
                        <button
                            key={tab}
                ...
                {isLoadingBank || loadingTransactions ? (
                    ...
                    <div className="w-full">
                        {activeTab === 'Movimientos' ? (
                            ...
                            <div className="w-full p-20 text-center text-gray-400 border border-dashed border-gray-200 rounded-xl bg-white shadow-sm">
